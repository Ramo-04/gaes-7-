...
<body>
    ...
    if (isset($_POST["calidad_filtro"]) && $_POST["calidad_filtro"] !== "") {
        $filtros[] = "calidad_servicio LIKE '%" . $_POST["calidad_filtro"] . "%'";
    }

    if (isset($_POST["duracion_filtro"]) && $_POST["duracion_filtro"] !== "") {
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="tabla-inventario">
                    ...
                    <a href="agregar_servicio.php" class="btn btn-volver btn-block mt-3">Agregar Servicio</a>
